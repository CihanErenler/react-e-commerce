...
const Hero = () => {
  return (
    <section className="h-screen relative ">
      <div className="container mx-auto h-full px-18 sm:px-28 relative z-10 text-center lg:text-left flex items-center lg:grid grid-cols-2 place-items-center gap-6">
        ...
        <div className="relative w-full h-2/3 p-10 hidden lg:block">
          <div className="absolute md:w-64 h-72 bg-orange-200 rounded-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"></div>
          <div className="rounded-md overflow-hidden absolute w-64  xl:w-80 z-10 bottom-10 left-10">
            <img src={bgg} alt="bgg" />
          </div>
